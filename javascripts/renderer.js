...
document.addEventListener('DOMContentLoaded', function() {
    ...
    var uri_search = [];
/// appel de l'uri grâce à la barre de recherche html
    let searchInput = document.getElementById('search-input');
    let searchResults = document.getElementById('search-results');
    searchInput.addEventListener('change', () => {
        //searchResults.innerHTML = 'Searching...';
        uri_search.push(searchInput.value);
        //searchResults.offsetHeight;
        //myConsole.log("deuxieme coucou");
        //myConsole.log(uri_search);
        //return uri_search;

//});  // a decommente
        myConsole.log(uri_search[0]);

        //var cy_1 = window.cy = cytoscape({
    ...
    //}
//});
//var instance_1 = cy_1.viewUtilities();
// store all the nodes in variable
        //populating childrenDat
//var nodes_1 = cy_1.elements.nodes;

//cy_1.nodes('[id = "market vendor"]').style('background-color', 'purple');
//instance.hide(cy_1.elements().difference(cy_1.getElementById('Service and sales workers').closedNeighborhood("id='Personal service workers'")));
//instance a cacher
...
// recupération des données de l'occupation
        ...
        var url_1 = 'http://ec.europa.eu/esco/api/resource/occupation/?language=en&uri='+uri_search[0];
        xhReq.open("GET",url_1,false);
...
//myConsole.log(edges);
        ...
        cy.nodes('[shape = "triangle"]').style('background-color', '#015dfd');
        //cy.nodes('[shape = "rectangle"]').style('rectangle','circle');
////
